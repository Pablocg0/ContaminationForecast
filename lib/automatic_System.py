...
def init():
    ...
    numRow = config.get('automatic_System', 'numRows')
    numColumns = config.get('automatic_System', 'numColumns')
    minlat = config.get('automatic_System', 'minlat')
    maxlat = config.get('automatic_System', 'maxlat')
    minlon = config.get('automatic_System', 'minlon')
    maxlon = config.get('automatic_System', 'maxlon')
    variables = config.get('automatic_System', 'variables')
